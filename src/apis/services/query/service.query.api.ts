...
export const serviceQueryApi = {
    getAllBookingCatalogServices: async (body: GetAllBookingCatalogServicesRequestType) => {
    ...
    getDetailBookingCatalogService: async (body: GetDetailBookingCatalogServiceRequestType) => {
